...
void main()
{
    ...
    float global_ambiental_intensity = 0.3;
    float ambient_light = material_kd * global_ambiental_intensity;
    ...
    float Kl = 0.2;
    float Kq = 0.3;
    float attenuation_factor = 1 / (Kc + Kl * d + Kq * d * d);
    ...
    // color = object_color * (light_color * light);
