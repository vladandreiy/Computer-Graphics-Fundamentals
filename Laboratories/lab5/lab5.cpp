...
void SurvivalMaze::Update(float deltaTimeSeconds) {
    ...
    {
        glm::mat4 modelMatrix = glm::mat4(1);
        modelMatrix = glm::translate(modelMatrix, glm::vec3(4, 1, 0));
...

    {
        glm::mat4 modelMatrix = glm::mat4(1);
        modelMatrix = glm::translate(modelMatrix, glm::vec3(-4, 1, 0));
        modelMatrix = glm::rotate(modelMatrix, RADIANS(45.0f), glm::vec3(1, 1, 1));
        modelMatrix = glm::scale(modelMatrix, glm::vec3(0.5, 1, 2));
        RenderMesh(meshes["box"], shaders["VertexNormal"], modelMatrix);
    }

    // Bonus: render object attached to camera
    /*
    {
        glm::mat4 modelMatrix = glm::mat4(1);
...
void SurvivalMaze::OnInputUpdate(float deltaTime, int mods) {
    ...
    if (window->MouseHold(GLFW_MOUSE_BUTTON_RIGHT)) {
        ...
        // Modify width/ height for orthogonal projection
