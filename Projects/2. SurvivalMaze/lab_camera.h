...
namespace SurvivalMazeCamera {
    ...
    public:
        ...
        void RotateFirstPerson_OY(float angle) {
            ...
            // vectors!
            glm::vec4 newVec = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0)) * glm::vec4(forward, 1);
            forward = glm::normalize(glm::vec3(newVec));

            newVec = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0)) * glm::vec4(right, 1);
        ...
        void RotateFirstPerson_OZ(float angle) {
            ...
            glm::vec4 newVec = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0)) * glm::vec4(right, 1);
            right = glm::normalize(glm::vec3(newVec));

            newVec = glm::rotate(glm::mat4(1.0f), angle, forward) * glm::vec4(up, 0);
            forward = glm::normalize(glm::vec3(newVec));
